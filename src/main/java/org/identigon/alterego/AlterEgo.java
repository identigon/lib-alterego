...
import org.identigon.alterego.pattern.PatternStrategy;
import org.identigon.alterego.store.MappingStore;
import org.identigon.alterego.strategy.CityStrategy;
import org.identigon.alterego.strategy.DateJitterStrategy;
import org.identigon.alterego.strategy.DateTimeJitterStrategy;
import org.identigon.alterego.strategy.DictionaryLoader;
import org.identigon.alterego.strategy.DomainNameStrategy;
import org.identigon.alterego.strategy.EmailAddressStrategy;
import org.identigon.alterego.strategy.FullNameStrategy;
import org.identigon.alterego.strategy.InstantJitterStrategy;
import org.identigon.alterego.strategy.NameDictionaryStrategy;
import org.identigon.alterego.strategy.OrganisationNameStrategy;
import org.identigon.alterego.strategy.PhoneNumberStrategy;
import org.identigon.alterego.strategy.PostcodeStrategy;
import org.identigon.alterego.strategy.StreetAddressStrategy;
...
public final class AlterEgo implements AutoCloseable {
  ...
  public Transformation<String> nhsNumber() {
    requireGB("nhsNumber");
    return bind("alterego:nhs-number", org.identigon.alterego.strategy.NhsNumberStrategy.INSTANCE);
  }
